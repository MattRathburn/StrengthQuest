...
INSERT INTO Lifts VALUES (@LiftId1, 200, 1, GETDATE(), @UId, @LiftNameId3, @LiftTypeId1, 1)
INSERT INTO Lifts VALUES (@LiftId2, 200, 1, GETDATE(), @UId, @LiftNameId2, @LiftTypeId2, 1)
INSERT INTO Lifts VALUES (@LiftId3, 200, 1, GETDATE(), @UId, @LiftNameId1, @LiftTypeId2, 1)
INSERT INTO Lifts VALUES (@LiftId4, 200, 1, GETDATE(), @UId, @LiftNameId4, @LiftTypeId3, 1)
